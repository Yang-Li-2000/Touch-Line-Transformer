...
REPLACE_LANGUAGE_INPUTS = False
DUMMY_LANGUAGE_INPUT = 'object'

COS_SIM_VERTEX = ['EYE', 'FINGERTIP', 'OBJECT'][0]

REPLACE_SENTENCE_WITH_TARGET_WORD = False

REMOVE_LANGUAGE_BY_SETTING_CAPTION_TO_NONE = False
